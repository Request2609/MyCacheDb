...
class Command :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Messages::Key >*
      mutable_keys();
  private:
  const ::Messages::Key& _internal_keys(int index) const;
  ::Messages::Key* _internal_add_keys();
  public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Messages::Value >*
      mutable_vals();
  private:
  const ::Messages::Value& _internal_vals(int index) const;
  ::Messages::Value* _internal_add_vals();
  public:
  ...
  private:
  const ::Messages::Time& _internal_time() const;
  ::Messages::Time* _internal_mutable_time();
  public:
...
// repeated string val = 1;
inline int Value::_internal_val_size() const {
  return val_.size();
}
...
inline const std::string& Value::_internal_val(int index) const {
...
// repeated string key = 1;
inline int Key::_internal_key_size() const {
  return key_.size();
}
...
inline const std::string& Key::_internal_key(int index) const {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Command::_internal_status() const {
  return status_;
}
...
inline void Command::_internal_set_status(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000004u;
  status_ = value;
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Command::_internal_len() const {
  return len_;
}
...
inline void Command::_internal_set_len(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000008u;
  len_ = value;
}
...
// repeated .Messages.Key keys = 4;
inline int Command::_internal_keys_size() const {
  return keys_.size();
}
...
inline const ::Messages::Key& Command::_internal_keys(int index) const {
...
inline ::Messages::Key* Command::_internal_add_keys() {
  return keys_.Add();
}
...
inline const ::Messages::Value& Command::_internal_vals(int index) const {
...
inline ::Messages::Value* Command::_internal_add_vals() {
  return vals_.Add();
}
...
inline bool Command::_internal_type() const {
  return type_;
}
...
inline void Command::_internal_set_type(bool value) {
  _has_bits_[0] |= 0x00000010u;
  type_ = value;
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Command::_internal_num() const {
  return num_;
}
...
inline void Command::_internal_set_num(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000020u;
  num_ = value;
}
...
inline const ::Messages::Time& Command::_internal_time() const {
...
inline ::Messages::Time* Command::_internal_mutable_time() {
  _has_bits_[0] |= 0x00000002u;
  if (time_ == nullptr) {
