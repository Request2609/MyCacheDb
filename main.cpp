...
int main(int argc, char** argv) {
    ...
    cout << "读取测试" << endl ;
    cout << "==================================================" << endl ;
    cout <<"开始时间:"<< tv.tv_sec<<"." << tv.tv_usec<<"s"<< endl; 
    cout <<"结束时间:"<< tend.tv_sec<<"." << tend.tv_usec<<"s"<< endl; 
    ...
    cout << "修改测试" << endl ;
    cout << "==================================================" << endl ;
    cout <<"开始时间:"<< tv1.tv_sec<<"." << tv1.tv_usec<<"s"<< endl; 
    cout <<"结束时间:"<< tend1.tv_sec<<"." << tend1.tv_usec<<"s"<< endl; 
